...
const TAB_DATA = [
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>TKR College of Engineering & Technology [Btech]</li>
        <li>Narayana Junior College [Inter]</li>
        <li>Sri chaitanya high school.</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>Udemy -Html and Css</li>
        <li>Udemy - JavaScript</li>
        <li>Udemy - React Js</li>
        <li>Udemy - NodeJs</li>
      </ul>
    ),
  },
